  ...
  <div :class="['app-container', darkMode ? 'dark' : '']">
    ...
    <div class="main-layout">
      ...
      <section class="galeria">
        <transition-group name="fade" tag="div" class="productos-scroll">
          <div
            v-for="reloj in relojesFiltrados"
            :key="reloj.id"
            class="tarjeta-producto"
          >
            <div class="etiqueta" v-if="reloj.etiqueta">{{ reloj.etiqueta }}</div>

            <!-- Ícono de favorito -->
            <i
              class="fas fa-heart icono-favorito"
              :class="{ favorito: favoritos.includes(reloj.id) }"
              @click="toggleFavorito(reloj.id)"
            ...
            <!-- Stock -->
            <p v-if="reloj.stock === 0" class="sin-stock">Sin stock</p>
            <p v-else class="stock-disponible">{{ reloj.stock }} disponibles</p>

            <!-- Botón agregar al carrito -->
            <button
              @click="agregarAlCarrito(reloj)"
              :disabled="reloj.stock === 0"
            >
...
const relojes = ref([
  { id: 1, nombre: 'Deepsea', precio: 120, imagen: reloj1, stock: 10, etiqueta: 'Nuevo', rating: 5 },
  { id: 2, nombre: '1958', precio: 150, imagen: reloj2, stock: 8, etiqueta: '', rating: 4 },
  { id: 3, nombre: 'Skyler White', precio: 90, imagen: reloj3, stock: 12, etiqueta: '', rating: 4 },
  { id: 4, nombre: 'Walter White', precio: 110, imagen: reloj4, stock: 9, etiqueta: '', rating: 3 },
])
